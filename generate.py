...
def get_option():
    argparser = ArgumentParser(
        description=
        '指定したテンプレートTeXファイルの"%%%INSERT HERE%%%"部分に別ファイルで指定したライブラリファイルを挿入する。')
